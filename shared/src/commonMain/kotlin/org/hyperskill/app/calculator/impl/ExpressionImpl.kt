package org.hyperskill.app.calculator.impl

import org.hyperskill.app.calculator.Expression
import org.hyperskill.app.calculator.FloatType
import org.hyperskill.app.calculator.InputToken
import org.hyperskill.app.calculator.inputTokenFromChar
...
class ExpressionImpl() : Expression {
    ...
    constructor(expr: String) : this() {
        for (char in expr)
            addToken(inputTokenFromChar(char) ?: throw RuntimeException("Unsupported token '$char'"))
    }
    ...
    companion object {
        private fun applyOperatorToStack(operator: OperatorToken, numbersStack: ArrayDeque<FloatType>): Boolean {
            when (operator) {
                is UnaryOperatorToken -> {
